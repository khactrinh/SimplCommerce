INSERT INTO public."Core_Role"("Id", "ConcurrencyStamp", "Name", "NormalizedName")
    VALUES (1, 'bd3bee0b-5f1d-482d-b890-ffdc01915da3', 'admin', 'ADMIN');

INSERT INTO public."Core_User" ("Id", "FullName", "IsDeleted", "CreatedOn", "UpdatedOn", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash", "SecurityStamp", "ConcurrencyStamp", "PhoneNumber", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnd", "LockoutEnabled", "AccessFailedCount") VALUES (1, N'Shop Admin', false, NOW(), NOW(), N'admin@SimplCommerce.com', N'ADMIN@SIMPLCOMMERCE.COM', N'admin@SimplCommerce.com', N'ADMIN@SIMPLCOMMERCE.COM', false, N'AQAAAAEAACcQAAAAEAEqSCV8Bpg69irmeg8N86U503jGEAYf75fBuzvL00/mr/FGEsiUqfR0rWBbBUwqtw==', N'9e87ce89-64c0-45b9-8b52-6e0eaa79e5b7', N'8620916f-e6b6-4f12-9041-83737154b338', NULL, false, false, NULL, true, 0);

INSERT INTO public."Core_UserRole" ("UserId", "RoleId") VALUES (1, 1);

INSERT INTO public."Core_ProductOption" ("Id", "Name") VALUES
(1, N'Color'),
(2, N'Size');

INSERT INTO public."Core_Country" ("Id", "Name") VALUES (1, N'Việt Nam');

INSERT INTO public."Core_StateOrProvince" ("Id", "CountryId", "Name", "Type") VALUES
...
INSERT INTO public."Core_District" ("Id", "Name", "Type", "Location", "StateOrProvinceId") VALUES
